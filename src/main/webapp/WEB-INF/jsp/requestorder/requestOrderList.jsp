...
<div class="slim-mainpanel">
	<div class="container">
		...
		<div class="section-wrapper mg-t-20">
			...
			<p class="mg-b-20 mg-sm-b-40">시스템에 등록된 발주 정보 목록입니다.</p>
			...
			<div class="search-box" style="border-radius: 0px; width: 200px; height: 40px;">
				<input id="income" type="date" class="form-control" name="user_name"
					size=5 placeholder="날짜입력 예) 2020-11-11" style="width: 200px; height: 40px;">
				<button class="btn btn-primary" id="btn" style="border-radius: 0%;">
